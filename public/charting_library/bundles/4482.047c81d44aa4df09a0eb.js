...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4482],
  {
    ...
    64482: (e, i, t) => {
      t.d(i, {
        SeriesPropertyDefinitionsViewModel: () => R,
        seriesPrecisionValues: () => H,
      });
      var o = t(50151),
        n = t(9343),
        r = t(11542),
      ...
      const C = (0, n.getLogger)('Chart.Definitions.Series'),
        ...
        $ = new l.TranslatedString(
          'toggle intraday inactivity gaps',
          r.t(null, void 0, t(28871))
        ),
        M =
          (new l.TranslatedString(
        ...
        E = (r.t(null, void 0, t(59777)), r.t(null, void 0, t(59766))),
        x = r.t(null, void 0, t(77073)),
        A = r.t(null, void 0, t(16564)),
        F = r.t(null, void 0, t(89212)),
        N = [
      ...
      function H() {
        ...
        for (let i = 0; i < N.length; i++)
          e.push({
            title: `${N[i].minMove}/${N[i].priceScale}`,
            value: `${N[i].priceScale},${N[i].minMove},${N[i].frac}`,
          });
        return e;
      }
      class R {
        ...
        async _createSeriesDefinitions() {
          ...
          return (
            s.enabled('intraday_inactivity_gaps') &&
              m.push(
                (0, a.createCheckablePropertyDefinition)(
                  {
                    checked: (0, a.convertToDefinitionProperty)(
          ...
          if (_) {
            const t = this._series.sessionIdProxyProperty(),
              ...
              n = (0, a.createOptionsPropertyDefinition)(
                ...
                { id: 'sessionId', title: O, options: this._sessionIdOptionsWV }
              );
            i.push(n);
