(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [1859],
  {
    ...
    14543: (e, t, n) => {
      ...
      n(9038);
      var a = n(15893);
      (n(50959), n(21593), n(66860), n(1538), n(88317));
      n(49406);
    },
    9038: (e, t, n) => {
      'use strict';
      ...
      const s = a.createContext({ isInButtonGroup: !1, isGroupPrimary: !1 }),
        c = (e, t, n) => {
          const c = (0, a.useContext)(o.CustomBehaviourContext),
            ...
            A = (0, a.useContext)(i.ControlGroupContext),
            { isInButtonGroup: N, isGroupPrimary: T } = (0, a.useContext)(s);
          return l(
            u,
            e.lightButton,
            x && e.link,
          ...
          !(0, r.isIconOnly)(m, n) &&
            a.createElement(
              'span',
              {
                ...
                'data-overflow-tooltip-text': c ?? (0, o.getTextForTooltip)(m),
              },
              s || i
                ? a.createElement(
                    a.Fragment,
    ...
    15893: (e, t, n) => {
      ...
      function d(e) {
        const { isGrouped: t } = a.useContext(l.ControlGroupContext),
          ...
          P = D ? (S ?? 2) : 1,
          R =
            P > 0 ? { ...k, '--ui-lib-light-button-content-max-lines': P } : k;
        return a.createElement(
          'button',
          {
            ...T,
    ...
    86720: (e, t, n) => {
      ...
      function b(e) {
        ...
        return o(
          ...
          i && g['disable-focus-outline'],
          a && g.fake,
          r && g['enable-cursor-pointer'],
          s && g[`margin-${t}`],
      ...
      const h = (0, l.forwardRef)((e, t) => {
        const { size: n, overflowBehaviour: a } = (0, l.useContext)(f),
      ...
      function T(e) {
        ...
        return l.createElement(D.Icon, {
          icon: N(t),
          className: o(A['arrow-icon'], A[`size-${t}`], n && A.dropped),
        });
      }
      var P = n(33636);
      const R = 4,
      ...
      function I(e) {
        const {
          ...
          b = (0, l.useRef)(null),
          y = (0, c.useMergedRefs)([d, b]),
          D = (function (e, t) {
            const n = (0, l.useRef)(Y);
            return (
              (0, l.useEffect)(() => {
              ...
              (0, l.useCallback)(() => {
                const a = (0, w.ensureNotNull)(
                    t.current
                  ).getBoundingClientRect(),
                  l = n.current[e];
                return {
                  x: a.left,
                  y: a.top + a.height + l + R,
                  indentFromWindow: { top: z, bottom: z, left: z, right: z },
                };
              }, [t, e])
            );
          })(t, b);
        return l.createElement(C.PopupMenuDisclosureView, {
          buttonRef: b,
          listboxTabIndex: -1,
          isOpened: a,
          onClose: g,
          ...
          popupChildren: s.map(e =>
            l.createElement(x.PopupMenuItem, {
              key: e.id,
              className: m ? P['link-item'] : void 0,
              onClick: v,
              onClickArg: e,
              isActive: p(e),
              label: e.label,
      ...
      const Y = { xsmall: 0, small: 0, medium: 0, large: 0, xlarge: 0 };
      var W = n(75774),
        M = n(86781),
        V = n(86240),
        F = n(98163);
      ...
      function U(e) {
        ...
        return l.createElement(
          'div',
          {
            className: o(H().underline, t && H().disabled),
            style: {
      ...
      function $(e) {
        const {
            ...
            orientation: v,
            disabled: g,
            moreButtonContent: b = i.t(null, void 0, n(37117)),
            size: h = 'small',
            onActivate: w,
            isActive: x,
            className: C,
            ...
            stretchTabs: N,
            equalTabSize: T,
            defaultKeyboardFocus: P,
            stopPropagationIfKeyboardActionHandled: R,
            keyboardNavigationLoop: z,
            focusableItemAttributes: B,
          } = e,
          Y = L(),
          W = (function (e) {
            const t = (0, M.useSafeMatchMedia)(
                V['media-mf-phone-landscape'],
                !0
              ),
              n = L();
          ...
          q = k ?? !Y,
          {
            ...
            moreButtonRef: ne,
            setItemRef: ae,
          } = (0, s.useCollapsible)(a, H, x),
          le = 'collapse' === W ? K : a,
          oe = 'collapse' === W ? Z : [],
          re = (0, l.useCallback)(e => oe.includes(e), [oe]),
          ie = (0, l.useRef)(new Map()),
          {
            isOpened: se,
            open: ce,
            close: ue,
          ...
          Ce = (0, l.useCallback)(e => pe.find(t => t.id === e.id) ?? {}, [pe]),
          De = (0, l.useCallback)(() => {
            (ue(), xe(), (Q.current = !0));
          }, [ue, xe]),
          Se = (0, l.useCallback)(() => {
        ...
        ((ve.ref = (0, c.useMergedRefs)([ve.ref, ee])),
          (fe.ref = (0, c.useMergedRefs)([fe.ref, te])),
          (fe.onKeyDown = (0, u.createSafeMulticastEventHandler)(
            (0, p.useKeyboardEventHandler)([
              (0, p.useKeyboardClose)(se, De),
              (0, p.useKeyboardActionHandler)(
                [13, 32],
                Se,
                (0, l.useCallback)(() => Boolean(we), [we])
              ),
            ]),
            fe.onKeyDown
          )));
        const ke = (0, l.useCallback)(
            e => {
              ((Q.current = !0), de(e));
            },
            [Q, de]
        ...
        (0, l.useEffect)(() => {
          Q.current ? (Q.current = !1) : (we && !se && ce(), !we && se && ue());
        }, [we, se, ce, ue]);
        const Oe = (function (e, t, n = []) {
          ...
          return (
            ...
            (0, l.useEffect)(() => {
              ...
              const n = e.get(t);
              return void 0 !== n
                ? (s(n), r.current?.observe(n), () => r.current?.disconnect())
                : void 0;
            }, n),
            a
          );
        })(ie.current, ye ?? we, [ye ?? we, le, h, $, W]);
        return l.createElement(
          f.Provider,
          { value: { size: h, overflowBehaviour: W } },
          l.createElement(
            'div',
            {
              ...ve,
              className: X({ size: h, overflowBehaviour: W, className: C }),
              style: D,
              'data-name': A,
            },
            l.createElement(
              ...
              Oe
                ? l.createElement(U, { ...Oe, disabled: g })
      ...
      (0, l.forwardRef)((e, t) => {
        const { size: n, overflowBehaviour: a } = (0, l.useContext)(f),
          o = (0, l.useContext)(v.CustomBehaviourContext),
          {
            ...
            fake: d,
            className: m,
            enableActiveStateStyles: p = o.enableActiveStateStyles,
    ...
    84828: (e, t, n) => {
      ...
      function u(e) {
        ...
        return a.createElement(c.Provider, { value: s }, n);
      }
      ...
      function m(e) {
        ...
        return a.createElement(d.Provider, { value: c }, n);
      }
      var p = n(11542),
        f = n(97754),
        v = n.n(f),
      ...
      function S(e) {
        ...
        return a.createElement(
          'div',
          { className: v()(D.row, j && D.mobileRow) },
          t
        );
      }
      var k = n(85528),
        E = n(76056);
      const O = a.createContext({ isActive: !1, isFocused: !1 });
      function A(e) {
        const {
            value: t,
            reference: n,
      ...
      function N(e) {
        const { isActive: t, isFocused: n } = (0, a.useContext)(O);
      ...
      function I(e) {
        ...
        return a.createElement(R.Calendar, {
          ...n,
          className: v()(z.calendar, t),
          popupStyle: !1,
        });
      }
      function B(e, t) {
      ...
      function W(e) {
        const {
          ...
          { date: s, setDate: u } = (0, l.ensureNotNull)((0, a.useContext)(c)),
          d = (0, a.useRef)(null),
          m = (0, a.useRef)(null);
        return (
          (0, a.useEffect)(() => {
              ...
              !o &&
                a.createElement(P, {
                  ...
                  onPick: function (e) {
                    const [t, n] = e.split(':'),
                      a = new Date();
                    (a.setHours(Number(t)), a.setMinutes(Number(n)));
                    const l = Y(a, s);
                    (u(l),
                      j || l.valueOf() === s.valueOf() || m.current?.focus());
                  },
                })
            ),
            !j &&
        ...
        function p(e) {
          (u(e),
            ...
            m.current?.setViewType(C.CalendarViewType.Month));
        }
      }
      function M(e) {
        const {
          ...
          } = e,
          {
            ...
            setDateFrom: s,
            setDateTo: c,
          } = (0, l.ensureNotNull)((0, a.useContext)(d)),
          [u, m] = (0, a.useState)('from'),
          p = (0, a.useRef)(null),
          f = (0, a.useRef)(null),
          v = (0, a.useRef)(null),
          g = (0, a.useMemo)(
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(P, {
                ...
                onPick: function (e) {
                  h(e, i, e => {
                    (c(e),
                      j || i.valueOf() === e.valueOf() || v.current?.focus());
                  });
                },
              })
            ),
            !j &&
              a.createElement(I, {
                ...
                onSelect: function (e) {
                  const t = B(e, 'from' === u ? r : i);
                  ({
                    from: () => {
                      (s(t), f.current?.focus({ preventScroll: !0 }));
                    },
                    to: () => {
                      c(t);
                    },
        ...
        function b(e) {
          (v.current?.setViewDate(e),
            v.current?.setViewType(C.CalendarViewType.Month));
        }
        function h(e, t, n) {
          const [a, l] = e.split(':'),
            o = new Date();
          (o.setHours(Number(a)), o.setMinutes(Number(l)));
          n(Y(o, t));
        }
      }
      var V = n(86720),
      ...
      function _(e) {
        const { dateOnly: t, onClose: o, onGoToDate: r, onGoToRange: i } = e,
          s = (0, a.useRef)(null),
          [u, m] = (0, a.useState)(
            h().getValue('GoToDialog.activeTab', 'Date')
          ),
          [f, b] = (0, a.useState)(0),
          { date: C, isValid: D } = (0, l.ensureNotNull)((0, a.useContext)(c)),
          {
            dateFrom: S,
            dateTo: k,
            isValid: E,
        ...
        return (
          (0, a.useEffect)(
            () => (
              g.subscribe(y.CLOSE_POPUPS_AND_DIALOGS_COMMAND, T, null),
              () => {
                g.unsubscribe(y.CLOSE_POPUPS_AND_DIALOGS_COMMAND, T, null);
              }
            ),
            [o]
          ),
          ...
          a.createElement(
            ...
            e =>
              a.createElement(x.AdaptiveConfirmDialog, {
                className: v()(L.dialogWrapper, e && L.dialogWrapperSmall),
          ...
          return (
            ...
            a.createElement(
              ...
              a.createElement(
                'div',
                { className: L.tabs },
                a.createElement(V.UnderlineButtonTabs, {
                  id: 'go-to-date-tabs',
                  isActive: e => e.id === u,
                  items: H,
                  onActivate: P,
              ...
              a.createElement(
                'div',
                { className: v()(L.content, j && L.contentMobile) },
                a.createElement(
                  'div',
        ...
        function P(e) {
          (m(e.id), h().setValue('GoToDialog.activeTab', e.id));
        }
        function R() {
          b(f + 1);
        }
            ...
            onGoToRange: (t, n) => {
              (!(function (e, t, n) {
                ...
                const l = o.linking.interval.value(),
                  i = l && (0, q.normalizeIntervalString)(l),
                  c = (0, s.get_timezone)(a),
                  u = e => (0, s.cal_to_utc)(c, new Date(e)),
                  d = (0, r.addLocalTime)(t).valueOf(),
                  m = (0, r.addLocalTime)(n).valueOf(),
                  p = {
                    val: {
                      type: 'time-range',
                      from: u(d) / 1e3,
