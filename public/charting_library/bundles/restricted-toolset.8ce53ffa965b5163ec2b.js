  ...
  [5516, 9685],
  {
    ...
    10428: (e, t, a) => {
      ...
      function C(e) {
        const {
          ...
          M = o()(C.label, a && !c && C.labelOn),
          T = o()(
            s,
            C.wrapper,
            a && C.wrapperWithOnLabel,
            h && C.wrapperWithDescription
          );
        return n.createElement(
          'label',
          {
            role: t,
            className: o()(T, f && C.withIcon, S.accessible),
            htmlFor: l,
            ref: m,
          ...
          void 0 !== f &&
            n.createElement(p.Icon, { className: C.icon, icon: f }),
          n.createElement(
            'div',
            { className: C.labelRow },
            n.createElement('div', { className: M }, r),
            h && n.createElement('div', { className: C.labelHint }, h)
          ),
          n.createElement(
            'div',
    ...
    95230: (e, t, a) => {
      ...
      var ge = a(16829),
        ...
        Se = a(39681),
        _e = a(69744);
      const Ce = (0, $.hotKeySerialize)({ keys: ['/'], text: '{0}' }),
            ...
            (this._handleSelectIndicator = e => {
              ...
              (async () => {
                ...
                if ('java' === e.type) {
                  ...
                  if (null !== t)
                    return (
                      await (0, de.initLineTool)(t),
                      void ue.tool.setValue(t)
                    );
                }
                    ...
                    n.createElement(
                      ...
                      n.createElement(
                        'div',
                        {
                          className: m()(
                            _e.dropdown,
                            e && _e.smallWidthWrapper
                          ),
                        },
                        n.createElement(
                          ge.ToolWidgetMenuSummary,
                          { className: e && _e.smallWidthTitle },
                            ...
                            this.state.infos.length > 0
                              ? this.state.infos.map(t =>
                                  n.createElement(A.AccessibleMenuItem, {
                                    role: 'menuitem',
                                    className: m()(e && _e.smallWidthMenuItem),
                                    theme: e
        ...
        _createMenuItems(e, t, a, i) {
          ...
          return (function (e) {
            ...
            return e.filter((e, a, i) => {
              let n = !0;
              return (
                e.type === _.PopupMenuSeparator &&
                  ((0 !== a && a !== i.length - 1) || (n = !1), t && (n = !1)),
                (t = e.type === _.PopupMenuSeparator),
                n
              );
            });
          })([].concat(...n));
        ...
        _renderResolutionsGroup(e, t = !1, a, i, s) {
          ...
          return (
            (!e.mayOmitSeparator || e.items.length > 1) &&
              ...
              o.push(
                n.createElement(_.PopupMenuSeparator, { key: `end-${e.name}` })
              )),
            o
          );
        }
            ...
            t
              ...
              : n.createElement(
                  ...
                  n.createElement(Z, {
                    ...
                    'data-tooltip-hotkey': _t || E ? '' : Ct ? Mt : '',
                  }),
                  f &&
                    n.createElement(
                      'div',
      ...
      function Gt(e) {
        ...
        const k = (e.snapshotUrl && e.snapshotUrl.length > 0) ?? !1;
        return n.createElement(
          n.Fragment,
          null,
          n.createElement(
      ...
      const ga = (0, rt.mergeThemes)(oe.DEFAULT_POPUP_MENU_ITEM_THEME, {
        ...
        _a = (0, rt.mergeThemes)(oe.DEFAULT_POPUP_MENU_ITEM_THEME, {
      ...
      function wa(e) {
        ...
        return n.createElement(Ca, { ...e, ...i, description: o, item: a });
      }
      var fa = a(97357);
        ...
        return n.createElement(
          ...
          d &&
            n.createElement(
              n.Fragment,
              null,
              n.createElement(_.PopupMenuSeparator, null),
