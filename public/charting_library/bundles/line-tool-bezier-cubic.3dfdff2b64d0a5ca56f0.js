...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [9014],
  {
      ...
      class v extends l.LineSourcePaneView {
        ...
        _updateImpl(e) {
          ...
          null !== s &&
            ...
            r.push(
              (0, i.ensureNotNull)(this._source.pointToScreenPoint(s[1]))
            ));
          const l = {
            points: r,
    ...
    35246: (e, t, n) => {
      (n.r(t),
        n.d(t, { BezierQuadroPaneView: () => c, cacheIsValid: () => d }));
      var i = n(50151),
        o = n(19063),
        r = n(27916),
        s = n(95201),
