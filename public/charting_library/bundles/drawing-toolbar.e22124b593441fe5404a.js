(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2878],
  {
    ...
    37159: (e, t, o) => {
      'use strict';
      (o.r(t), o.d(t, { DrawingToolbarRenderer: () => Co }));
      var n = o(50959),
        i = o(32227),
        l = o(50151),
        s = o(97754),
                ...
                i &&
                  n.createElement(
                    ...
                    n.createElement(
                      ...
                      n.createElement(w.Icon, { icon: F, className: E.icon })
                    )
                  ),
                i &&
                  n.createElement(
      ...
      const Ue = {
        ...
        [W.Stickers]: {
          ...
          RowComponent: function (e) {
            return n.createElement(Oe.EmojisRow, {
              ...e,
      ...
      const $e = {
        ...
        et = parseInt(Qe['default-drawer-min-top-distance']);
      function tt(e) {
      ...
      const mo = u.enabled('right_toolbar'),
        ...
        po =
          (u.enabled('saveload_separate_drawings_storage'), (0, v.onWidget)()),
        go = new m.Delegate(),
        ...
        constructor(e) {
          (super(e),
            ...
            (this._handleDrawingClick = e => {
              (fo('drawing mode', e), wo('drawing mode', e ? 'on' : 'off'));
            }),
            (this._handleLockClick = e => {
              (fo('lock all drawing', e), wo('lock', e ? 'on' : 'off'));
            }),
            (this._handleSyncClick = e => {
              (fo('sync', e), wo('sync', e ? 'on' : 'off'));
            }),
