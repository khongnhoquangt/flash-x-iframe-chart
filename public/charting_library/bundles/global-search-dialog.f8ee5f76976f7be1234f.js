  ...
  [9754, 1754, 9685, 2544],
  {
    ...
    46350: (e, t, o) => {
          ...
          (0, n.useEffect)(() => {
            ...
            if (e)
              return (
                ...
                I(),
                () => {
                  e && e.removeEventListener('input', I);
                }
              );
          }, []));
      ...
      function ee(e) {
        ...
        if (!t) return null;
        const [, o, n, i] = t;
        return [parseInt(o), parseInt(n), parseInt(i)];
      }
      function te(e) {
      ...
      class ye extends W {
        constructor(e) {
          (super({
            ...
            shortcutHint: (0, D.humanReadableHash)(D.Modifiers.Alt + 73),
          }),
            (this._model = e));
      ...
      class Te extends W {
        constructor(e) {
          (super({
            ...
            shortcutHint: (0, D.humanReadableHash)(D.Modifiers.Alt + 80),
            disabled:
      ...
      class Se extends W {
        constructor(e) {
          (super({
            ...
            shortcutHint: (0, D.humanReadableHash)(D.Modifiers.Alt + 76),
            disabled:
              e.mainSeries().priceScale().isLockScale() ||
              6 === e.mainSeries().properties().childs().style.value(),
      ...
      async function Be(e) {
              ...
              e.options().goToDateEnabled &&
                t.push(
                  new W({
                    ...
                    shortcutHint: (0, D.humanReadableHash)(
                      D.Modifiers.Alt + 71
                    ),
                  })
                ),
        ...
        (t.push(
          new W({
            ...
            shortcutHint: (0, D.humanReadableHash)(D.Modifiers.Alt + 82),
          })
        ),
        ...
        t.push(
          new W({
            ...
            checked: T.value(),
            onExecute: () => {
              e.model().setProperty(T, !T.value(), De);
            },
          })
        );
            ...
            t.push(
              new W({
                ...
                onExecute: () => {
                  ...
                  e.model().setProperty(y.averageClosePriceLineVisible, t, Ie);
                },
              })
            ));
        ...
        (t.push(
          ...
          t.push(
            new W({
              ...
              shortcutHint: (0, D.humanReadableHash)(
                D.Modifiers.Mod + D.Modifiers.Alt + 81
              ),
            })
          ));
        const M = e
          ...
          O.enabled('header_widget') &&
            ...
            (t.push(
              new W({
                ...
                shortcutHint: (0, D.humanReadableHash)(D.Modifiers.Mod + 90),
              })
            ),
            t.push(
              new W({
                ...
                shortcutHint: (0, D.humanReadableHash)(D.Modifiers.Mod + 89),
              })
            )),
          t.push(
            new W({
          ...
          O.enabled('header_widget') &&
            ...
            t.push(
              new W({
                ...
                shortcutHint: (0, D.humanReadableHash)(D.Modifiers.Shift + 70),
              })
            ),
          t
        );
          ...
          (function (e) {
            const t = Ne.lineToolsInfo[e],
              ...
              i = {
                ...
                icon: t.icon,
                shortcutHint: n ? (0, D.humanReadableHash)(n) : void 0,
                payload: e,
          ...
          (super(),
            ...
            (this.show = e => {
              this.visible().value() ||
                (async function (e, t) {
                  ...
                  if (
                    ...
                    (!O.enabled('show_interval_dialog_on_key_press') ||
                      ...
                      (t.shortcutHint = (0, D.humanReadableHash)(188)),
                      n.push(new W(t)));
                  }
                  if (
                    t &&
                ...
                })(this._activeChartWidget, this._loadChartService).then(t => {
                  ((this._actions = t
                    .concat(
                      (() => {
                        const e = new W({
