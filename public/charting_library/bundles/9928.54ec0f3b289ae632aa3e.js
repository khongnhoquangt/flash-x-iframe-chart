(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [9928],
  {
    ...
    67248: (t, e, n) => {
      ...
      function g(t) {
        const {
          ...
          R = (function (t) {
            ...
            return (
              0 !== t &&
                (1 & t && (e = u(e, m()['no-corner-top-left'])),
                2 & t && (e = u(e, m()['no-corner-top-right'])),
                4 & t && (e = u(e, m()['no-corner-bottom-right'])),
                8 & t && (e = u(e, m()['no-corner-bottom-left']))),
              e
            );
          })((0, h.getGroupCellRemoveRoundBorders)(c)),
          C = a && (o || s);
        return u(
          i,
          m().button,
      ...
      function f(t) {
        ...
        return c.createElement(
          ...
          r && !i && c.createElement('span', { className: m().content }, r),
          o &&
            c.createElement(
              'span',
        ...
        const {
          ...
          p =
            ...
            (t.primaryText
              ...
              : (0, b.getTextForTooltip)(t.children));
        return c.createElement(
          'button',
          {
            ...w(l),
            'aria-disabled': r,
            tabIndex: t.tabIndex ?? (r ? -1 : 0),
            className: m,
            ref: e,
            onClick: C(o, r),
            onMouseDown: C(i, r),
    ...
    67029: (t, e, n) => {
      ...
      function m(t, e, n, r) {
        const {
          ...
          R = d(s ?? (0, c.getGroupCellRemoveRoundBorders)(n));
        return o(
          h().container,
          h()[`container-${u}`],
          h()[`intent-${i}`],
      ...
      function p(t, e, n) {
        ...
        const a = d(s ?? (0, c.getGroupCellRemoveRoundBorders)(e));
      ...
      function b(t, e) {
        ...
        return r.createElement(
          ...
          y,
          P,
          r.createElement('span', { className: p(t, N, E) })
        );
      }
    ...
    31261: (t, e, n) => {
      ...
      function v(t) {
        ...
        const {
          ...
          D = (0, a.createSafeMulticastEventHandler)(
            R.onFocus,
            function (t) {
              n && !y.current && (0, i.selectAllContent)(t.currentTarget);
            },
            s
          ),
    ...
    86623: (t, e, n) => {
      ...
      function c(t) {
        const {
          ...
          A = (0, s.useControlValidationLayout)({
            hasErrors: p,
            hasWarnings: g,
            hasSuccessMessages: f,
            errors: b,
          ...
          F = (0, i.createSafeMulticastEventHandler)(n, A.onFocus),
          k = (0, i.createSafeMulticastEventHandler)(c, A.onBlur),
          T = (0, i.createSafeMulticastEventHandler)(u, A.onMouseOver),
          z = (0, i.createSafeMulticastEventHandler)(h, A.onMouseOut);
        return r.createElement(
          r.Fragment,
          null,
          r.createElement(o.InputControl, {
            ...
            onMouseOver: T,
            onMouseOut: z,
            containerReference: (0, l.useMergedRefs)([d, A.containerReference]),
            endSlot: r.createElement(
              r.Fragment,
              null,
              A.icon && r.createElement(a.EndSlot, { icon: !0 }, A.icon),
              m
            ),
            'aria-required': B,
            'aria-invalid': W,
            'aria-describedby': A.ariaIds,
            'aria-label': N,
          }),
          A.renderedErrors
        );
    ...
    1140: (t, e, n) => {
      ...
      function N(t, e, n) {
        return t === S.Attached && W(e, n);
      }
      function M(t, e, n) {
        return t === S.Static && W(e, n);
      }
      function Z(t, e, n) {
        const {
            hasErrors: r,
      ...
      function A(t) {
        const {
          ...
          S = r.useCallback(
            t => {
              ...
              (e.has(t) ? e.delete(t) : e.set(t, t),
                0 !== e.size ? w(Array.from(e.keys()).join(' ')) : w(void 0));
            },
            [w, y.current]
          ),
          {
            ...
            showAttachedErrorMessages: W,
            showAttachedWarningMessages: N,
            showStaticErrorMessages: M,
            showStaticWarningMessages: A,
            showStaticSuccessMessages: k,
            showErrorIcon: T,
            showWarningIcon: z,
            intent: I,
          } = Z(t, g, b),
          O =
            T || z
              ? r.createElement(P, { intent: T ? 'danger' : 'warning' })
              : void 0,
          _ = D
            ? r.createElement(B, {
                errorAttachment: c,
          ...
          L = M
            ? r.createElement(
                ...
                e?.map((t, e) =>
                  r.createElement(F, { key: e, messageIdCallback: S }, t)
                )
              )
            : void 0,
          j = A
          ...
          H =
            !M && !A && !k && p
              ? r.createElement(
                  ...
                  r.createElement(F, { messageIdCallback: S }, p)
                )
              : void 0;
        return {
          ariaIds: C,
          icon: O,
          renderedErrors: _ ?? K ?? L ?? j ?? U ?? H,
